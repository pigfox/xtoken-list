...
#1 passed
#forge test --rpc-url "$SEPOLIA_HTTP_RPC_URL" --gas-report --verbosity --ffi --etherscan-api-key "$ETHERSCAN_API_KEY" --match-contract Arbitrage --match-test test_setProfitAddress #
#2 passed
