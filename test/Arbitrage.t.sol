...
contract ArbitrageTest is Test {
    ...
    function setUp() public {
        ...
        console.log("Wallet PFX Balance:", walletBalance);
        ...
        console.log("DEX1 PFX Balance:", dex1Balance);
        console.log("DEX2 PFX Balance:", dex2Balance);
        ...
        console.log("Arbitrage ETH Balance:", arbitrageEth);
    ...
    function test_executeArbitrage() public {
        ...
        console.log("Initial Arbitrage ETH:", initialEth);
        console.log("Initial Wallet ETH:", initialProfitEth);
